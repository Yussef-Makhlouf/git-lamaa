...
const blogPosts = [
  ...
  {
    title: 'كيفية الحفاظ على نظافة المكتب',
    excerpt: 'نصائح عملية للحفاظ على بيئة عمل نظيفة وصحية لزيادة الإنتاجية وتحسين الروح المعنوية.',
    image: '/clean-office.png',
    date: '5 يونيو 2023',
    author: 'سارة أحمد',
    slug: 'office-cleaning-maintenance',
